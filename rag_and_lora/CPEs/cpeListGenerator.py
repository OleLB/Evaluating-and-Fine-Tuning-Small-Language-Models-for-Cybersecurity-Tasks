...
from rag_and_lora.CPEs.cpeParser import cpe_to_human
import sqlite3
import csv
import json

DATABASE = "db/cve_database.db"
SAVE_LOCATION = "db/cpe_list.csv"
...
if __name__ == "__main__":
    ...
    save_cpe_to_csv(cpe_entries, SAVE_LOCATION)
    
    conn.close()
    print(f"Saved {len(cpe_entries)} CPE entries to {SAVE_LOCATION}")