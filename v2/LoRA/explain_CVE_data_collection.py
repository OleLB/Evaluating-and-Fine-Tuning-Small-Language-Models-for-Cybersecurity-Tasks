...
from utils.querySQLite import getRandomCVEs, getDescription
...
PROMPT_PATH = "LoRA/cve_summary_prompt.txt"
...
def getCVEDetails(cve_id: str) -> dict:
    ...
    """
    conn = sqlite3.connect('../db/cve_database.db')  # Adjust path as needed
    cursor = conn.cursor()
